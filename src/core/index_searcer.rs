...
// use super::{
//     get_min_row_id, DimId, DimWeight, GenericInvertedIndexMmapType, GenericPostingsIterator, PostingListIter, QuantizedWeight, ScoreType, SparseVector, TopK
// };
// const ADVANCE_BATCH_SIZE: usize = 10_000;

// pub struct IndexedPostingListIterator<OW: QuantizedWeight, TW: QuantizedWeight, PI>
// where
//     PI: PostingListIter<OW, TW>,
// {
