...
//     F32Quantized(IndexedPostingListIterator<f32, u8, PostingListIterator<'a, f32, u8>>),
//     F16NoQuantized(
...
//         >,
//     ),
//     F16Quantized(IndexedPostingListIterator<half::f16, u8, PostingListIterator<'a, half::f16, u8>>),
...
//         IndexedPostingListIterator<f32, u8, CompressedPostingListIterator<'a, f32, u8>>,
//     ),
...
//         IndexedPostingListIterator<half::f16, u8, CompressedPostingListIterator<'a, half::f16, u8>>,
//     ),
...
//                 Self::F32Quantized(InvertedIndexRamBuilder::<f32, u8>::new(ElementType::SIMPLE))
//             }
//             (IndexWeightType::Float32, false) => {
//                 Self::F32NoQuantized(InvertedIndexRamBuilder::<f32, f32>::new(ElementType::SIMPLE))
//             }
//             (IndexWeightType::Float16, true) => {
//                 Self::F16Quantized(InvertedIndexRamBuilder::<half::f16, u8>::new(ElementType::SIMPLE))
//             }
//             (IndexWeightType::Float16, false) => {
//                 Self::F16NoQuantized(InvertedIndexRamBuilder::<half::f16, half::f16>::new(ElementType::SIMPLE))
//             }
//             (IndexWeightType::UInt8, true) => panic!("U8 Can't be quantized!"),
//             (IndexWeightType::UInt8, false) => {
//                 Self::U8NoQuantized(InvertedIndexRamBuilder::<u8, u8>::new(ElementType::SIMPLE))
//             }
//         }
//     }
...
//                             OW::to_f32(max_weight_in_longest) * query_weight;
...
//                 let max_weight_in_longest = element.weight().max(element.max_next_weight());
//                 let max_score_contribution = OW::to_f32(max_weight_in_longest) * query_weight;
//                 if max_score_contribution <= min_score {
...
//     postings_iterators: &mut Vec<IndexedPostingListIterator<OW, TW, PostingListIterator<'a, OW, TW>>>,
...
//     query_weight_offset: usize,
//     query_values: &[DimWeight],
//     compressed_postings_iterators: &mut Vec<IndexedPostingListIterator<OW, TW, CompressedPostingListIterator<'a, OW, TW>>>,
//     min_row_id: &mut RowId,
//     max_row_id: &mut RowId,
// ) where
//     OW: QuantizedWeight,
...
//                 let mut postings_iterators_f32_quantized: Vec<IndexedPostingListIterator<f32, u8, PostingListIterator<'_, f32, u8>>> = Vec::new();
//                 process_posting_list_for_inverted_index(
//                     &inverted_index_mmap,
//                     dim_id,
//                     dim_id_idx,
...
//                         half::f16,
//                         u8,
//                         PostingListIterator<'_, half::f16, u8>,
//                     >,
//                 > = Vec::new();
//                 process_posting_list_for_inverted_index(
//                     &inverted_index_mmap,
...
//                     IndexedPostingListIterator<f32, u8, CompressedPostingListIterator<'_, f32, u8>>,
//                 > = Vec::new();
//                 process_posting_list_for_compressed_inverted_index(
//                     &compressed_inverted_index_mmap,
//                     dim_id,
...
//                         half::f16,
//                         u8,
//                         CompressedPostingListIterator<'_, half::f16, u8>,
//                     >,
//                 > = Vec::new();
//                 process_posting_list_for_compressed_inverted_index(
//                     &compressed_inverted_index_mmap,
