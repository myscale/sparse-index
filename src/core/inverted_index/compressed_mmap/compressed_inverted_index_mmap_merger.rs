...
impl<'a, OW: QuantizedWeight, TW: QuantizedWeight> CompressedInvertedIndexMmapMerger<'a, OW, TW> {
    ...
    pub fn merge(
        ...
        for dim_id in min_dim_id..(max_dim_id + 1) {
            ...
            trace!("[{}]-[cmp-mmap-merger]-[dim-id:{}] store header-obj, left:{}, right:{}, copy:{}, approximate_storage:{}",
                thread_name!(),
                dim_id,
                header_offset_left,
                header_offset_right,
            ...
            trace!("[{}]-[cmp-mmap-merger]-[dim-id:{}] store row-ids, left:{}, right:{}, copy:{}, approximate_storage:{}",
                thread_name!(),
                dim_id,
