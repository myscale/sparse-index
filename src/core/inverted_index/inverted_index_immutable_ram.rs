...
impl InvertedIndex for InvertedIndexImmutableRam {
    ...
    fn open(path: &Path) -> std::io::Result<Self> {
        ...
        // TODO: 只要 core 中出现了一个 sparse vector 包含比较高的 dim, 那么就要创建很多中间空的 posting list？
        // TODO: 对于上面这个场景, 需要测试一下当 dim 超级大的时候，会不会直接让内存/存储干崩溃了
    ...
    fn remove(&mut self, _id: ElementOffsetType, _old_vector: RemappedSparseVector) {
